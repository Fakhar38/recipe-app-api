...
class ModelTest(TestCase):
    ...
    @patch('uuid.uuid4')
    def test_image_uuid_path(self, mock_uuid):
        """
            Test the file path generated by uuid for images
        """
        uuid = 'test-uuid'
        mock_uuid.return_value = uuid

        filepath = models.get_recipe_image_file_path(None, 'sample-image.jpg')
